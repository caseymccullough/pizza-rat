...
- attributes:
    ...
    - weight - initially 0
    - mood - initially 0
    - hamsters - initially an empty array
...
- weapons: use the following array of objects
    ```js
    [
        {
            name: 'Sprinkle Spray'
...
- Submit your homework via google form before the next class starts at 10AM and please don't forget to fill out the form!
...
1. Expand this to your heart's content! The sky is the limit!
